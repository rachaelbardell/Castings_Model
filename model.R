...
df <- read.csv("~/Documents/Intern_Model/052113_intern_model/castings_data.csv", header = TRUE, stringsAsFactors=FALSE)
...
for(pred in predictors){
  ...
  ggsave(file=paste("~/Desktop/Intern_Model/Diagnostic_Plots/VarVSPrice/", pred, ".jpeg"))
}
...
ggsave("~/Desktop/Intern_Model/Diagnostic_Plots/ObsVSResidual.jpeg")
...
ggsave("~/Desktop/Intern_Model/Diagnostic_Plots/ObservedPriceVSResiduals.jpeg")
...
ggsave("~/Desktop/Intern_Model/Diagnostic_Plots/PredictedVSResiduals.jpeg")
...
ggsave(file = "~/Desktop/Intern_Model/Diagnostic_Plots/qqplot.jpeg")
...
for(var in vars){
  ...
  ggsave(file=paste0("~/Desktop/Intern_Model/Diagnostic_Plots/VarVSResiduals/", var, ".jpeg"))
}
